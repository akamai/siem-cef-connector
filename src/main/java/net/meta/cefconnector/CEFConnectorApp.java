...
public class CEFConnectorApp {
      ...
      try {
        ...
        if (statusCode == 200) {
          ...
          try (BufferedReader is =
              new BufferedReader(new InputStreamReader(response.getEntity().getContent()), 1024 * 32)) {
          ...
          try {
            if (isJSONValid(responseData)) {
              ...
              responseError = String.format(
                  ...
                  lineObject.getString("type"), lineObject.getString("title"), lineObject.getString("instance"),
                  lineObject.getString("detail"), lineObject.getString("method"), lineObject.getString("serverIp"),
  ...
  /*
   * Description: Attempts to create a JSONObject or JSONArray to confirm validity of JSON format Arguments: String test
   * Return: boolean
   */
